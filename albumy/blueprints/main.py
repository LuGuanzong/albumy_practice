...
def search():
    ...
    if category == 'user':
        pagination = User.query.whooshee(q).paginate(page, per_page)
    elif category == 'tag':
        pagination = Tag.query.whooshee(q).paginate(page, per_page)
    else:
...
def collect(photo_id):
    ...
    if photo.author != current_user and photo.author.receive_collect_notification:
