...
class Role(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(30), unique=True)
    users = db.relationship('User', back_populate='role')
    permissions = db.relationship('Pemission', secondary=roles_permissions, back_populates='roles')
...
class Collect(db.Model):
    ...
    collector = db.relationship('Collector', back_populates='collections', lazy='joined')
